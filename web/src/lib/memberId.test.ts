...
describe("isValidMemberIdText", () => {
  ...
  it("rejects member Ids that do not start with 400", () => {
    expect(isValidMemberIdText("12345678")).toEqual(false);
    expect(isValidMemberIdText("40345678")).toEqual(false);
    expect(isValidMemberIdText("000345678")).toEqual(false);
  });
