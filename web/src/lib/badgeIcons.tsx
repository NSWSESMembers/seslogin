import { TIER_ICON_PALETTE, type BadgeTier } from "./badgeTiers";
...
type BadgeIconSvgBaseProps = BadgeIconProps & {
  gradientId: string;
};
...
// The four-channel (outer/inner/ring/symbol) fill palette per tier lives in
// lib/badgeTiers.ts (TIER_ICON_PALETTE) — the single source of truth shared
// with TIER_PILL_CLASS — see that file's doc comment for why it's plain hex
// rather than CSS custom properties.
function paletteForTier(tier: BadgeTier) {
  return TIER_ICON_PALETTE[tier];
}
...
function badgeIconFileStemForBadgeId(badgeId: string): string {
  if (isLocationStampBadgeId(badgeId)) {
    return "first-signin-location-template";
  }
  return badgeId;
}
...
function SymbolForBadge({
  ...
  if (isLocationStampBadgeId(badgeId)) {
    ...
    return (
      <g transform="rotate(-14 38 38)">
        ...
        />
        <path
          d="M38 20l1.9 5.6h5.9l-4.8 3.5 1.9 5.6-5-3.5-5 3.5 1.9-5.6-4.8-3.5h5.9z"
          fill={color}
        />
        <path
          d="M22 37h32M25 49h26"
          stroke={color}
          strokeWidth="1.6"
          strokeLinecap="round"
        />
        <text
          ...
          fontWeight="800"
          fontSize={fontSize}
          fontFamily="AtkinsonHyperlegible, Verdana, sans-serif"
  ...
  if (badgeId === "checkin-momentum-builder") {
    return (
      <>
        <path
          d="M24 50h8M24 43h16M24 36h24M24 29h32"
          stroke={color}
          strokeWidth="4"
          strokeLinecap="round"
        />
        <circle cx="56" cy="29" r="4" fill={color} />
      </>
    );
  }
  ...
  if (badgeId === "public-holiday-new-years-day") {
    return (
      <>
        <circle
          cx="38"
        ...
        />
        <path
          d="M38 16v5M38 55v5M16 38h5M55 38h5M22 22l3.5 3.5M50.5 50.5L47 47M22 54l3.5-3.5M50.5 25.5L47 29"
          stroke={color}
          strokeWidth="3"
          strokeLinecap="round"
        />
  ...
  if (badgeId === "public-holiday-australia-day") {
    return (
      <>
        <path
          d="M24 52V24"
        ...
        />
        <path
          d="M24 24c8-2 10 4 18 2s10-8 18-6v20c-8-2-10 4-18 2s-10-8-18-6z"
          fill="none"
          stroke={color}
          strokeWidth="3.5"
          strokeLinejoin="round"
        />
        <path
          d="M44 27.5l1.7 3.5 3.8.5-2.8 2.7.6 3.8-3.3-1.8-3.3 1.8.6-3.8-2.8-2.7 3.8-.5z"
          fill={color}
        />
      </>
    );
  }
  if (badgeId === "public-holiday-anzac-day") {
    return (
      <>
        <circle cx="38" cy="34" r="4.5" fill={color} />
        <ellipse
          cx="38"
          cy="24"
          rx="4"
  ...
  if (badgeId === "public-holiday-april-fools-day") {
    return (
      <>
        {/* Jester's crown — three points with pom-poms */}
        <path d="M18 50h15l-13-24z" fill={color} />
        <path d="M28 50h20l-10-33z" fill={color} />
        <path d="M43 50h15l-2-24z" fill={color} />
        <circle cx="20" cy="24" r="3.4" fill={color} />
        <circle cx="38" cy="15" r="3.6" fill={color} />
        <circle cx="56" cy="24" r="3.4" fill={color} />
        <rect x="18" y="48" width="40" height="7" rx="3" fill={color} />
      </>
    );
  }
  if (badgeId === "public-holiday-christmas-day") {
    return (
      <>
        <path
          d="M38 18l2.2 4.6 5 .7-3.6 3.4.9 4.9-4.5-2.4-4.5 2.4.9-4.9-3.6-3.4 5-.7z"
          fill={color}
        />
        <path
          d="M38 26l-12 12h7l-9 12h11l-8 10h22l-8-10h11l-9-12h7z"
          fill="none"
          stroke={color}
          strokeWidth="3.5"
          strokeLinejoin="round"
        />
        <rect x="35" y="60" width="6" height="6" rx="1" fill={color} />
      </>
    );
  }
  if (badgeId === "public-holiday-boxing-day") {
    return (
      <>
        <rect
          x="22"
        ...
        />
        <path
          d="M22 39h32M38 30v24"
          stroke={color}
          strokeWidth="3.5"
          strokeLinecap="round"
        />
        <path
          d="M38 30c0-6 8-6 8 0 0 3-2 5-8 9-6-4-8-6-8-9 0-6 8-6 8 0z"
          fill="none"
          stroke={color}
          strokeWidth="3"
          strokeLinejoin="round"
  ...
  if (badgeId === "accredited-rescue-role-first-on-scene") {
    return (
      <>
        <circle
          cx="38"
        ...
        <circle cx="38" cy="38" r="7" fill={color} />
        <path
          d="M38 22v8M38 46v8M22 38h8M46 38h8"
          stroke={color}
          strokeWidth="4"
          strokeLinecap="round"
        />
  ...
  if (badgeId === "accredited-rescue-role-rescue-regular") {
    return (
      <>
        <path
          d="M38 20l14 6v11c0 10-7 16-14 19-7-3-14-9-14-19V26z"
          stroke={color}
          strokeWidth="3.5"
          fill="none"
          strokeLinejoin="round"
  ...
  if (badgeId === "accredited-rescue-role-rescue-specialist") {
    return (
      <>
        <path
          d="M22 40c0-9 7-16 16-16s16 7 16 16"
          stroke={color}
          strokeWidth="4"
          fill="none"
          strokeLinecap="round"
        />
        <path
          d="M24 40h28v10a8 8 0 0 1-8 8H32a8 8 0 0 1-8-8z"
          stroke={color}
          strokeWidth="3.5"
          fill="none"
        />
  ...
  if (badgeId === "accredited-rescue-role-rescue-royalty") {
    return (
      <>
        <path
          d="M24 48h28"
        ...
        />
        <path
          d="M26 48l-4-18 10 7 6-12 6 12 10-7-4 18"
          stroke={color}
          strokeWidth="3.5"
          fill="none"
          strokeLinecap="round"
        ...
        />
        <path
          d="M38 18l2.8 5.8 6.4.9-4.6 4.5 1.1 6.3-5.7-3-5.7 3 1.1-6.3-4.6-4.5 6.4-.9z"
          fill={color}
        />
      </>
    );
  ...
  if (badgeId === "maintenance-equipment-tool-time") {
    return (
      <g transform="translate(11.75 13.85) scale(2.1)">
        <path
  ...
  if (badgeId === "training-other-side-quest") {
    return (
      <>
        ...
        />
        <circle cx="27" cy="42" r="2" fill={color} />
        <path
          d="M43 24l7 7M50 24l-7 7"
          stroke={color}
          strokeWidth="3"
          strokeLinecap="round"
        />
  ...
  if (badgeId === "workshop-regular") {
    return (
      <>
        <path
          d="M20 50V24l12 6 12-6 12 6v20l-12-6-12 6z"
          stroke={color}
          strokeWidth="3.5"
          fill="none"
          strokeLinejoin="round"
  ...
  if (badgeId === "workshop-seasoned") {
    return (
      <>
        ...
        />
        <path
          d="M26 52v6M38 52v6M50 52v6"
          stroke={color}
          strokeWidth="3"
          strokeLinecap="round"
        />
        <path
          d="M28 34h20M28 40h14"
          stroke={color}
          strokeWidth="3.5"
          strokeLinecap="round"
        />
  ...
  if (badgeId === "workshop-legend") {
    return (
      <>
        <path
          d="M22 50h32l-2-20H24z"
          stroke={color}
          strokeWidth="3.5"
          fill="none"
          strokeLinejoin="round"
  ...
  if (badgeId === "easter-forgot-my-password") {
    return (
      <>
        <rect
          x="24"
        ...
        <path
          ...
          strokeLinecap="round"
        />
        <circle cx="38" cy="38" r="2.4" fill={color} />
        <path
          d="M16 36c0-8 6-14 14-14"
          stroke={color}
          strokeWidth="3"
          fill="none"
          strokeLinecap="round"
        />
        <path d="M27 17l4 5-6 2z" fill={color} />
      </>
    );
  }
...
function BadgeIconSvgBase({
  badgeId,
  badgeName,
  tier,
  className,
  gradientId,
}: BadgeIconSvgBaseProps) {
...
export function StaticBadgeIconSvg({
  badgeId,
  badgeName,
  tier,
  className,
}: BadgeIconProps) {
  const fileStem = badgeIconFileStemForBadgeId(badgeId);
  return (
    <BadgeIconSvgBase
      badgeId={badgeId}
      badgeName={badgeName}
      tier={tier}
      className={className}
      gradientId={`badge-gradient-${fileStem}`}
    />
  );
}

// `tier` isn't part of BadgeIconProps' destructuring here: the by-id SVG files
// this renders are already tier-colored per badge (hand-authored, keyed only
// by badgeId), unlike StaticBadgeIconSvg's inline artwork, which draws its
// own tier palette and does need it.
export function BadgeIcon({ badgeId, badgeName, className }: BadgeIconProps) {
  const fileStem = badgeIconFileStemForBadgeId(badgeId);
  const iconSrc = `/image/badges/by-id/${fileStem}.svg`;
