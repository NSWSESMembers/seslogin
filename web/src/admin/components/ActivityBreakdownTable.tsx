      ...
      <div className="border-t border-line-strong">
        {rows.map((entry) => (
          <Fragment key={entry.id}>
            <div className="flex justify-between gap-3 border-b border-line px-1.5 py-1.5">
            ...
            {entry.children.map((child) => (
              <div
                ...
                className="flex justify-between gap-3 border-b border-line px-1.5 py-1.5 text-ink-muted"
              >
