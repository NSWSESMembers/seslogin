...
/**
 * Deliberately does NOT mirror the kiosk's own reading of the key (see
 * `themeFromConfig` in KioskMain, which now treats an omitted key as auto):
 * this still shows Light for an omitted key, matching the value written on
 * pre-migration sessions before their `theme` key is backfilled explicit.
 */
