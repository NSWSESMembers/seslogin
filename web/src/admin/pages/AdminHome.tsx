    ...
    <div className="grid gap-4.5">
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(210px,1fr))] gap-3">
        ...
        <StatCard
          ...
          splitLine={
            disaggregateVirtualPeriods
              ? `${summary.checkIns7DVirtual} virtual · ${summary.checkIns7D - summary.checkIns7DVirtual} non-virtual`
              : undefined
          }
        />
        <StatCard
          ...
          splitLine={
            disaggregateVirtualPeriods
              ? `${formatHours(summary.totalTime7DVirtual)} virtual · ${formatHours(summary.totalTime7D - summary.totalTime7DVirtual)} non-virtual`
              : undefined
          }
        />
      </div>
