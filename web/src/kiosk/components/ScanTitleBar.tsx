  ...
  return (
    <div className="fixed inset-0 z-96" role="dialog" aria-modal="true">
      <button
        ...
        onClick={props.onClose}
      />
      <div className="absolute top-1/2 left-1/2 max-h-[calc(100vh-40px)] min-h-[min(640px,calc(100vh-40px))] w-[min(1140px,calc(100vw-24px))] -translate-1/2 overflow-auto rounded-[14px] border border-[rgba(123,155,206,0.4)] bg-linear-to-b from-[#f9fcff] to-[#edf3ff] p-4 text-[#20344f] shadow-[0_24px_60px_rgba(0,0,0,0.38)]">
              ...
              {rows.map((row, idx) => (
                ...
                >
                  ...
                  <div className="min-w-0 [grid-area:member]">
                    <div className="text-[1.1rem] leading-tight font-extrabold text-[#172d4b]">
