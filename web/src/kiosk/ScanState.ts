...
/**
 * Answer to the "you may have forgotten to sign out" interstitial: mark the
 * prompt as dealt with so the flow moves on to category selection. `endTime` is
 * set only when the person confirmed they left earlier ("Yeah") — leaving it
 * undefined lets the adjust screen default the sign-out to now, as it would for
 * any other sign-out.
 */
